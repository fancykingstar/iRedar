                                ...
                                <section>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-6">
                                            ...
                                            <input type="email" className="form-control" id="confirmEmail" name="confirmEmail" placeholder="name@example.com" />
                                        </div>
                                    </div>
                                ...
                                <section>
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-5">
                                            ...
                                            <input type="email" className="form-control" id="occupation_other" name="occupation_other" />
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="form-group col-md-6">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="licensed_no" name="licensed" type="radio" className="custom-control-input" />
                                                    <span className="custom-control-label">No</span>
                                                </label>
                                                <label className="custom-control custom-radio">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-6">
                                            ...
                                            <input type="email" className="form-control" id="degree_other" name="degree_other" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-6">
                                            ...
                                            <input type="text" className="form-control" id="nameOfMajor" name="nameOfMajor" />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="postSecondaryOutsideCanada_yesOther" name="postSecondaryOutsideCanada" type="radio" className="custom-control-input" />
                                                    <span className="custom-control-label">YES (other)</span>
                                                </label>
                                                <label className="custom-control custom-radio">
                                                    <input id="postSecondaryOutsideCanada_no" name="postSecondaryOutsideCanada" type="radio" className="custom-control-input" />
                                                    <span className="custom-control-label">NO</span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="degreeEvaluated_no" name="degreeEvaluated" type="radio" className="custom-control-input" />
                                                    <span className="custom-control-label">NO</span>
                                                </label>
                                                <label className="custom-control custom-radio">
                                                    <input id="degreeEvaluated_na" name="degreeEvaluated" type="radio" className="custom-control-input" />
                                                    <span className="custom-control-label">N/A</span>
                                                </label>
                                                <label className="custom-control custom-radio">
                                                    <input id="degreeEvaluated_inProgress" name="degreeEvaluated" type="radio" className="custom-control-input" />
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="securityClearance_no" name="securityClearance" type="radio" className="custom-control-input" />
                                                    <span className="custom-control-label">NO</span>
                                                </label>
                                ...
                                <section>
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-3">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input name="landingDate_citizen" id="landingDate_citizen" type="text" className="form-control" placeholder="MM/DD/YYYY" />
                                            </div>
                                        </div>
                                        <div className="form-group col-md-3">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-3">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input name="landingDate_permanentResident" id="landingDate_permanentResident" type="text" className="form-control" placeholder="MM/DD/YYYY" />
                                            </div>
                                        </div>
                                    </div>
                                    <h5>OR</h5>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <div className="custom-controls-stacked">
                                                        ...
                                                        <label className="custom-control custom-radio">
                                                            <input id="temporaryResident_foreignWorker" name="temporaryResident" type="radio" className="custom-control-input" />
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <div className="custom-controls-stacked">
                                                        ...
                                                        <label className="custom-control custom-radio">
                                                            <input id="temporaryResident_noWorkPermit_internationalStudent" name="temporaryResident_noWorkPermit" type="radio" className="custom-control-input" />
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-8">
                                            ...
                                            <input type="email" className="form-control" id="immigrationStatus_other" name="immigrationStatus_other" />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        <div className="form-group col-md-8">
                                            <label htmlFor="immigrationDocumentNumber">Immigration Document Number:</label>
                                            <input type="email" className="form-control" id="immigrationDocumentNumber" name="immigrationDocumentNumber" />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        <div className="form-group col-md-6">
                                ...
                                <section>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <div className="custom-controls-stacked">
                                                        ...
                                                        <label className="custom-control custom-radio">
                                                            <input id="legallyWorkInCanada_no" name="legallyWorkInCanada" type="radio" className="custom-control-input" />
                                                            <span className="custom-control-label">NO</span>
                                                        </label>
                                                        <label className="custom-control custom-radio">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group col-md-6">
                                            ...
                                            <input type="email" className="form-control" id="heardAboutUs_other" name="heardAboutUs_other" />
                                        </div>
                                    </div>
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <div className="custom-controls-stacked">
                                                        ...
                                                        <label className="custom-control custom-radio">
                                                            <input id="addEmailToDistributionList_no" name="addEmailToDistributionList" type="radio" className="custom-control-input" />
                                                            <span className="custom-control-label">NO</span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="form-row">
                                            <div className="form-group col-md-6">
                                                ...
                                                <select className="form-control" id="sourceOfIncome" name="sourceOfIncome">
                                                    <option value="">--</option>
                                                    <option>EI</option>
                                                    <option>ODSP</option>
                                                    <option>Ontario Works</option>
                                            ...
                                            <div className="form-group col-md-6">
                                                ...
                                                <input type="email" className="form-control" id="sourceOfIncome_other" name="sourceOfIncome_other" />
                                            </div>
                                        </div>
                                    </div>
