                            ...
                            <div id="wizard6">
                                ...
                                <section id="wizard6-p-0" role="tabpanel" aria-labelledby="wizard6-h-0"
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-3">
                                            ...
                                            <select className="form-control" id="employmentField"
                                                    name="employmentField" readOnly={!isEditable}
                                                    disabled={!isEditable}
                                                    onChange={(e) => {
                                                    }}>
                                                <option value="">--</option>
                                            ...
                                            <div className="custom-controls-stacked">
                                                <label className="custom-control custom-radio">
                                                    <input id="frenchLanguageAssessed_yes" name="frenchLanguageAssessed"
                                                           type="radio" className="custom-control-input readOnly={!isEditable}
                                                    disabled={!isEditable}
                                                    onChange={(e) => {}}"
                                                    />
                                                    <span className="custom-control-label">Yes</span>
                                ...
                                <section id="wizard6-p-2" role="tabpanel" aria-labelledby="wizard6-h-2"
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                <label className="custom-control custom-radio">
                                                    <input id="resumeBrought_yes" name="resumeBrought" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="resumeBrought_no" name="resumeBrought" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}/>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            ...
                                            <input type="text" className="form-control" id="improvementToResume"
                                                   name="improvementToResume" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                        </div>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            ...
                                            <input type="text" className="form-control" id="desiredJobLocation"
                                                   name="desiredJobLocation" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                        </div>
                                    ...
                                    <div className="form-row">
                                        <div className="form-group col-md-12">
                                            ...
                                            <input type="text" className="form-control" id="usedJobSearchMethods"
                                                   name="usedJobSearchMethods" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                        </div>
                                            ...
                                            <div className="custom-controls-stacked">
                                                <label className="custom-control custom-radio">
                                                    <input id="connectedWithPeopleInDesiredField_yes"
                                                           name="connectedWithPeopleInDesiredField" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                <label className="custom-control custom-radio">
                                                    <input id="interviews_yes" name="interviews" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="interviews_no" name="interviews" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="hasResearchedTheField" name="hasResearchedTheField"
                                               readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value="" id="isSearching"
                                               name="isSearching" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="hasTransferableSkills" name="hasTransferableSkills"
                                               readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="hasStrongResume" name="hasStrongResume" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="ableToTargetResumeforOpportunities"
                                               name="ableToTargetResumeforOpportunities" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value="" id="canUseSTAR"
                                               name="canUseSTAR" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="positiveAttitude" name="positiveAttitude" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                ...
                                <section id="wizard6-p-2" role="tabpanel" aria-labelledby="wizard6-h-2"
                                    ...
                                    <div className="form-row">
                                        <div className="form-check form-group">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   id="elegibleForJobSearchWorkshop"
                                                   name="elegibleForJobSearchWorkshop" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="referredToCareerAccessForNewcomers"
                                               name="referredToCareerAccessForNewcomers" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                        <label className="form-check-label"
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="referredToRoadmapToEmployment" name="referredToRoadmapToEmployment"
                                               readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="clientNotReferred" name="clientNotReferred" readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-row">
                                        <div className="form-check form-group col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_attendingSchool" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   id="clientNotReferred_languageSkills"
                                                   name="clientNotReferred_languageSkills" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   id="clientNotReferred_childCare" name="clientNotReferred_childCare"
                                                   readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                        ...
                                        <div className="form-check form-group  col-md-3">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_noOccupationGoal" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   id="clientNotReferred_transportation"
                                                   name="clientNotReferred_transportation" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                    ...
                                    <div className="form-row">
                                        <div className="form-check form-group col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   id="clientNotReferred_health" name="clientNotReferred_health"
                                                   readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                        ...
                                        <div className="form-check form-group  col-md-3">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_unsuitableExpectation" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-3">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_noTimeForAssignments" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_needsJobQuickly" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_lowComputerSkills" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                    ...
                                    <div className="form-row">
                                        <div className="form-check form-group col-md-6">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_limitedInterests" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-4">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   ...
                                                   name="clientNotReferred_directReferrals" readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                            <label className="form-check-label"
                                        ...
                                        <div className="form-check form-group  col-md-2">
                                            <input className="form-check-input" type="checkbox" value=""
                                                   id="clientNotReferred_other" name="clientNotReferred_other"
                                                   readOnly={!isEditable}
                                                   disabled={!isEditable}
                                                   onChange={(e) => {
                                                   }}/>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col">
                                            <div className="custom-controls-stacked">
                                                <label className="custom-control custom-radio">
                                                    <input id="eligibleForFINP_yes" name="eligibleForFINP" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}
                                                ...
                                                <label className="custom-control custom-radio">
                                                    <input id="eligibleForFINP_no" name="eligibleForFINP" type="radio"
                                                           className="custom-control-input" readOnly={!isEditable}
                                                           disabled={!isEditable}
                                                           onChange={(e) => {
                                                           }}/>
                                ...
                                <section id="wizard6-p-2" role="tabpanel" aria-labelledby="wizard6-h-2"
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="actionPlanCheckBox_one" name="actionPlanCheckBox_one"
                                               readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
                                    ...
                                    <div className="form-check form-group">
                                        <input className="form-check-input" type="checkbox" value=""
                                               id="actionPlanCheckBox_two" name="actionPlanCheckBox_two"
                                               readOnly={!isEditable}
                                               disabled={!isEditable}
                                               onChange={(e) => {
                                               }}/>
